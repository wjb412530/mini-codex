...
封装了官方的 OpenAI Python SDK，用于连接 OpenAI 以及任何支持 OpenAI API 规范的模型（如 Qwen、DeepSeek 等）。
...
class OpenAIProvider(LLMProvider):
    ...
    def __init__(self, api_key: str, base_url: str = None, model: str = 'gpt-4o'):
        ...
        self.system_prompt = (
            '你是一个名为 mini-codex 的高级 AI 编程助手。你拥有读取文件、写入文件和执行终端命令的权限。'
    ...
    def _get_tool_schemas(self) -> List[dict]:
        ...
        from mini_codex.tools.registry import registry
